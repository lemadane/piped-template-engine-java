...
public final class CssNode implements ASTNode {
    final String expression;
    final ASTNode body;
    final ExpressionEvaluator evaluator;

    public CssNode(String expression, ExpressionEvaluator evaluator) {
        this.expression = expression;
        this.body = null;
        this.evaluator = evaluator;
    }

    public CssNode(ASTNode body) {
        this.expression = null;
        this.body = body;
        this.evaluator = null;
    }

    public CssNode(String expression, ASTNode body, ExpressionEvaluator evaluator) {
        this.expression = expression;
        this.body = body;
        this.evaluator = evaluator;
    }
    ...
    ConditionalExpression parseConditionalExpression(String source) {
        ...
        if (outputSource.isBlank()) {
            throw new TemplateSyntaxException("Conditional CSS expression must not be empty.");
        }
        if (conditionExpression.isBlank()) {
            throw new TemplateSyntaxException("Conditional CSS condition must not be empty.");
        }
